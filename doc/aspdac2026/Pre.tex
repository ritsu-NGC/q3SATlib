...
{\it Quantum gates} describe transformations in qubits. The main ones that concern this work
...
All of the gates in Fig.~\ref{fig-gates} can in turn be composed into
{\it quantum circuits}. 
