...
\lstick{\ket{x_a}}    && \qw & \qw       & \gate{T}              & \targ     & \qw      & \ctrl{2} & \gate{T}               & \targ     & \ctrl{4} & \qw         & \qw                              & \qw       & \ctrl{2} & \qw \\
                      &&     &           & \push{x_b \oplus x_c} &           &          &          & \push{x_a \oplus x_b } &           &          &             & \push{x_a \oplus x_b \oplus x_c} &           &          &       \\
\lstick{\ket{x_b}}    && \qw & \targ     & \gate{T}              & \qw       & \ctrl{2} & \targ    & \gate{T^\dagger}       & \ctrl{-2} & \qw      & \targ       & \gate{T^{\dagger}}               & \targ     & \targ    & \qw \\
                      &&     &           & \push{x_c}            &           &          &          & \push{x_b}             &           &          &             &                                  &           &          &       \\
\lstick{\ket{x_c}}    && \qw & \ctrl{-2} & \gate{T^{\dagger}}    & \ctrl{-4} & \targ    & \qw      & \gate{T}               & \qw       & \targ    & \ctrl{-2}   & \qw                              & \ctrl{-2} & \qw      & \qw
}
