...
\begin{example}
  ...
  ~\figref{fig-phase-n4} to implement a cube by using a Multiple Control Toffoli (MCT) gate in place of the
  $F$-controlled gate. When implemented with a single ancilla, this circuit T-count of 15 and T-depth of 7.
  This means that after the rewrite, the function saves a further 7 T-gates, and a T-depth of 3.
\end{example}
