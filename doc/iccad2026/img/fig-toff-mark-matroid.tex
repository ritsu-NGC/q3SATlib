...
\Qcircuit @C=0.5em @R=0.2em @!R {
                       &           &     &           &&     &           & \push{x_a}            &           &          &          & \push{x_a \oplus x_c}  &           &          &             &                                  &           &          &       \\
\lstick{\ket{x_a}}     & \ctrl{4}  & \qw &           && \qw & \qw       & \gate{T}              & \targ     & \qw      & \ctrl{2} & \gate{T^\dagger}       & \targ     & \ctrl{4} & \qw         & \qw                              & \qw       & \ctrl{2} & \qw \\
                       &           &     &           &&     &           & \push{x_b \oplus x_c} &           &          &          & \push{x_a \oplus x_b } &           &          &             & \push{x_a \oplus x_b \oplus x_c} &           &          &       \\
\lstick{\ket{x_b}}     & \ctrl{2}  & \qw & \push{=}  && \qw & \targ     & \gate{T^\dagger}      & \qw       & \ctrl{2} & \targ    & \gate{T^\dagger}       & \ctrl{-2} & \qw      & \targ       & \gate{T}                         & \targ     & \targ    & \qw \\
                       &           &     &           &&     &           & \push{x_c}            &           &          &          & \push{x_b}             &           &          &             &                                  &           &          &       \\
\lstick{\ket{x_c}}     & \ctrl{-2} & \qw &           && \qw & \ctrl{-2} & \gate{T}              & \ctrl{-4} & \targ    & \qw      & \gate{T}               & \qw       & \targ    & \ctrl{-2}   & \qw                              & \ctrl{-2} & \qw      & \qw
}
