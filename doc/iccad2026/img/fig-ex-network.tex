...
% Inputs (left)
\node[lab] (x0) at (0,  3) {$x_0$};
\node[lab] (x1) at (0,  1.5) {$x_1$};
\node[lab] (x2) at (0,  0) {$x_2$};
\node[lab] (x3) at (0, -1.5) {$x_3$};
\node[lab] (x4) at (0, -3) {$x_4$};

% Internal logic nodes (placed left-to-right following dataflow)

% .names x0 x1 new_n8   (truth table: 00 1)  => new_n8 = ~x0 & ~x1
\node[nodebox] (n8) at (1, 2) {\scriptsize $i_0 = !x_0  !x_1$};

% .names x2 new_n8 new_n9  (11 1) => new_n9 = x2 & new_n8
\node[nodebox] (n9) at (2.5, 1) {\scriptsize $i_1 = x_2  i_0$};

% .names x3 new_n9 po0  (01 1) => po0 = ~x3 & new_n9
\node[nodebox] (po0box) at (4, 0) {\scriptsize $po_0 = !x_3  i_1$};

% .names x2 new_n8 new_n11 (01 1) => new_n11 = ~x2 & new_n8
\node[nodebox] (n11) at (2.5, -1) {\scriptsize $ i_2 = !x_2  i_0$};

% .names x3 new_n11 new_n12 (11 1) => new_n12 = x3 & new_n11
\node[nodebox] (n12) at (4, -2) {\scriptsize $i_3 = x_2  i_2$};

% .names x4 new_n12 po1 (01 1) => po1 = ~x4 & new_n12
\node[nodebox] (po1box) at (5.5, -3) {\scriptsize $po_1 = !x_4  i_3$};
